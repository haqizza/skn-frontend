<template>
  <div class="mx-auto py-12 w-3/5 flex flex-col items-center">
    <h2 class="mb-8 text-yellow-800">KIRIMI KAMI PESAN</h2>
    ...
    <div class="px-6 py-1 mt-8 align-self-end bg-accentOrange hover:bg-slate-400">KIRIM</div>
  </div>
</template>
